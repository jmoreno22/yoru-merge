...
- **Then:** the commit file list's share of the inspector height is ≥ 50 % at every window size from 960 × 640 upward (expanded) and ≥ 75 % (collapsed); at the bottom or with stacked panels its height is ≥ the share it keeps with the inspector on the right; at the minimum window the body clamp floors at 1 line and the header scrolls inside its cap before the list ever drops below 2 rows (AC-03). <!-- amended 2026-09-07 (owner) -->
