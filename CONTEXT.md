...
- inspector — the workbench column placed right of or below the centre view, holding the commit header, the commit file list, the diff viewer, and any blame or file-history panels stacked beneath. NOT the refs panel.
